...
public class DBConnector 
{
    ...
    public DBConnector ()
    {
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://iotinagriculture-mysqldbserver.mysql.database.azure.com/agri_data","MSISharif@iotinagriculture-mysqldbserver","MD74274385$");
   ...
   public ResultSet get_check_soil(String land_type, String soil_l, String a, String b, int change) throws SQLException
   {
       ...
       if(change == 3)
         {
              String query = "select soil_series from soil_information where land_classification ='"+land_type+"' && soil_series ='"+soil_l+"' && soil_solidness = '"+b+"'";
              check_soil =  st.executeQuery(query);     
         }
